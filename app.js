...
app.get("/about",(req,res)=>{
  res.render("about",{aboutContent:aboutContent});//key:value  key whats in the ejs file value is whats in the js file
...
app.post("/compose",(req,res)=>{
  ...
  const content = req.body.post_text;
  const post=new Post({
    title:title,
    content:content
  });
...
app.get("/posts/:postid",(req,res) =>{
  const posttitle =req.params.postid;//converts texts into lower case discards - or any onther
  console.log(posttitle);
  Post.findOne({_id:posttitle},(err,post) =>{
    if (!err){
      // console.log(post);
  ...
  //     res.render("post",{posttile:post.title,postcontent:post.content});
  //   };
  // });
});
